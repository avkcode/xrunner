...
const (
	JobService_SubmitJob_FullMethodName     = "/xrunner.v1.JobService/SubmitJob"
	JobService_GetJob_FullMethodName        = "/xrunner.v1.JobService/GetJob"
	JobService_ListJobs_FullMethodName      = "/xrunner.v1.JobService/ListJobs"
	JobService_StreamJobLogs_FullMethodName = "/xrunner.v1.JobService/StreamJobLogs"
)
...
type JobServiceClient interface {
	...
	StreamJobLogs(ctx context.Context, in *StreamJobLogsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[LogChunk], error)
}
...
func (c *jobServiceClient) StreamJobLogs(ctx context.Context, in *StreamJobLogsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[LogChunk], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &JobService_ServiceDesc.Streams[0], JobService_StreamJobLogs_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[StreamJobLogsRequest, LogChunk]{ClientStream: stream}
...
type JobService_StreamJobLogsClient = grpc.ServerStreamingClient[LogChunk]
...
type JobServiceServer interface {
	...
	StreamJobLogs(*StreamJobLogsRequest, grpc.ServerStreamingServer[LogChunk]) error
...
func (UnimplementedJobServiceServer) StreamJobLogs(*StreamJobLogsRequest, grpc.ServerStreamingServer[LogChunk]) error {
...
func _JobService_StreamJobLogs_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(JobServiceServer).StreamJobLogs(m, &grpc.GenericServerStream[StreamJobLogsRequest, LogChunk]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type JobService_StreamJobLogsServer = grpc.ServerStreamingServer[LogChunk]

// JobService_ServiceDesc is the grpc.ServiceDesc for JobService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var JobService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "xrunner.v1.JobService",
	...
	Metadata: "xrunner/v1/jobs.proto",
}
